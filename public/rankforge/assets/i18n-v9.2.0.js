...
(() => {
  ...
  const PHRASES = [
    ...
    ["Guten Morgen", "Good morning", "早上好", "सुप्रभात", "Buenos días", "صباح الخير"],
    ["Guten Abend", "Good evening", "晚上好", "शुभ संध्या", "Buenas tardes", "مساء الخير"],
    ["Gute Nacht", "Good night", "晚安", "शुभ रात्रि", "Buenas noches", "تصبح على خير"],
    ["Hallo", "Hello", "你好", "नमस्ते", "Hola", "مرحبًا"],
    ["Schön, dass du da bist.", "Good to see you.", "很高兴见到你。", "आपको देखकर अच्छा लगा।", "Qué bien verte.", "سعيد برؤيتك."],
    ...
    ["Dein erstes Training erscheint hier.", "Start your first workout now.", "立即开始第一次训练。", "अपना पहला वर्कआउट अभी शुरू करें।", "Empieza ahora tu primer entrenamiento.", "ابدأ أول تمرين الآن."],
