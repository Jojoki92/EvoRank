const CACHE = "evorank-x6.1-r1";
const CORE = [
  "./assets/evorank-x5.1-ui.css?build=x6.1-r1",
  "./assets/progress-x5.1.js?build=x6.1-r1",
  "./assets/rank-art-x5.1.js?build=x6.1-r1",
  "./assets/evorank-x5.1.js?build=x6.1-r1",
  "./assets/sports-profile-x5.3.js?build=x6.1-r1",
  "./assets/interface-x5.5.js?build=x6.1-r1",
  "./assets/interface-x5.9.js?build=x6.1-r1",
  "./assets/friends-x6.0.js?build=x6.1-r1",
  "./assets/interface-x6.1.js?build=x6.1-r1",
  ...
  "./assets/evorank-x5.0-ui.css?build=x6.1-r1",
  "./assets/legal-theme-x5.0.js?build=x6.1-r1",
  "./assets/cloud-consent-x4.9.js?build=x6.1-r1",
  "./assets/apple-interface-x4.9.js?build=x6.1-r1",
  "./assets/legal-links-x4.9.js?build=x6.1-r1",
  "./assets/evorank-x4.9-ui.css?build=x6.1-r1",
  "./assets/legal-x4.9.css?build=x6.1-r1",
  "./cookies.html",
  "./refunds.html",
  "./impressum.html",
  "./accessibility.html",

  "./assets/endurance-ranking-x4.8.js?build=x6.1-r1",
  "./assets/evorank-x4.8.js?build=x6.1-r1",
  "./assets/evorank-x4.8-ui.css?build=x6.1-r1",
  "./assets/age-ranking-x4.7.js?build=x6.1-r1",
  "./assets/evorank-x4.7.js?build=x6.1-r1",
  "./assets/evorank-x4.7-ui.css?build=x6.1-r1",
  "./assets/evorank-x4.6-ui.css?build=x6.1-r1",
  "./assets/evorank-x4.5-ui.css?build=x6.1-r1",
  "./assets/evorank-x4.5.js?build=x6.1-r1",
  "./assets/strava-x4.5.js?build=x6.1-r1",
  "./assets/evorank-alarm-x4.5.wav",
  "./hilfe-x4.5.html",
  "./assets/evorank-x4.4-ui.css?build=x6.1-r1",
  "./assets/exercise-families-x4.3.js?build=x6.1-r1",
  "./assets/evorank-x4.3-ui.css?build=x6.1-r1",
  "./assets/strength-standards-x4.2.js?build=x6.1-r1",
  "./assets/endurance-tracker-x4.2.js?build=x6.1-r1",
  "./assets/evorank-x4.2-ui.css?build=x6.1-r1",
  "./assets/brand-x4.1/evorank-er-flat.png",
  "./assets/brand-x4.1/evorank-er-flat-256.png",
  "./assets/evorank-x4.1-ui.css?build=x6.1-r1",
  "./assets/evorank-x4-brand.css?build=x6.1-r1",
  "./assets/evorank-x3-ui.css?build=x6.1-r1",
  "./assets/evorank-x2-ranks.js?build=x6.1-r1",
  "./assets/evorank-x2-ui.js?build=x6.1-r1",
  "./assets/evorank-x2-ui.css?build=x6.1-r1",
  "./icons/evorank-x4-maskable-512.png?build=x6.1-r1",
  "./",
  "./index.html",
  "./manifest.webmanifest?build=x6.1-r1",
  "./version.txt",
  "./cloud-config.js?build=x6.1-r1&mode=auto",
  "./garmin-connect-config.js?build=x6.1-r1",
  "./assets/account-sync-v2.js?build=x6.1-r1",
  "./assets/account-bridge-v1.js?build=x6.1-r1",
  "./assets/account-ui-v2.js?build=x6.1-r1",
  "./app-config-v9.1.1.js?build=x6.1-r1",
  "./assets/bootstrap-v9.1.1.js?build=x6.1-r1",
  "./assets/security-bootstrap-v9.1.1.js?build=x6.1-r1",
  "./assets/rankforge-v9.2.0.css?build=x6.1-r1",
  "./assets/rankforge-v9.2.0-patch.css?build=x6.1-r1",
  "./assets/triathlon-v9.7.css?build=x6.1-r1",
  "./assets/calendar-plan-v10.0.css?build=x6.1-r1",
  "./assets/home-control-v10.1-r1.css?build=x6.1-r1",
  "./assets/rank-dashboard-v10.2-r1.css?build=x6.1-r1",
  "./assets/rank-dashboard-v10.3-r1.css?build=x6.1-r1",
  "./assets/home-rank-frame-v10.4-r1.css?build=x6.1-r1",
  "./assets/bodygraph-selection-v10.6-r1.css?build=x6.1-r1",
  "./assets/evorank-v10.8-r1.css?build=x6.1-r1",
  "./assets/evorank-v10.9-r1.css?build=x6.1-r1",
  "./assets/evorank-v10.10-r1.css?build=x6.1-r1",
  "./assets/evorank-v10.11-r1.css?build=x6.1-r1",
  "./assets/workout-clarity-v10.11.1.css?build=x6.1-r1",
  "./assets/evorank-v10.11.2-r1.css?build=x6.1-r1",
  "./assets/evorank-v10.11.3-r1.css?build=x6.1-r1",
  "./assets/evorank-v10.11.4-r1.css?build=x6.1-r1",
  "./assets/evorank-v10.11.5-r1.css?build=x6.1-r1",
  "./assets/evorank-x1-r1.css?build=x6.1-r1",
  "./assets/bodygraph-v9.1.1.js?build=x6.1-r1",
  "./assets/rankforge-v9.2.0.js?build=x6.1-r1",
  "./assets/i18n-v9.2.0.js?build=x6.1-r1",
  "./assets/rankforge-v9.2.0-patch.js?build=x6.1-r1",
  "./assets/account-local-v10.7-r2.js?build=x6.1-r1",
  "./assets/rf93-unilateral-v1.js?build=x6.1-r1",
  "./assets/rf93-friends-v1.js?build=x6.1-r1",
  "./assets/triathlon-v9.7.js?build=x6.1-r1",
  "./assets/calendar-plan-v10.0.js?build=x6.1-r1",
  "./assets/home-control-v10.1-r1.js?build=x6.1-r1",
  "./assets/rank-dashboard-v10.2-r1.js?build=x6.1-r1",
  "./assets/rank-dashboard-v10.3-r1.js?build=x6.1-r1",
  "./assets/home-rank-frame-v10.4-r1.js?build=x6.1-r1",
  "./assets/evorank-brand-v10.7-r1.js?build=x6.1-r1",
  "./assets/evorank-v10.8-r1.js?build=x6.1-r1",
  "./assets/evorank-v10.9-r1.js?build=x6.1-r1",
  "./assets/evorank-v10.10-r1.js?build=x6.1-r1",
  "./assets/evorank-v10.11-r1.js?build=x6.1-r1",
  "./assets/evorank-v10.11.2-r1.js?build=x6.1-r1",
  "./assets/evorank-v10.11.3-r1.js?build=x6.1-r1",
  "./assets/evorank-v10.11.4-r1.js?build=x6.1-r1",
  "./assets/evorank-v10.11.5-r1.js?build=x6.1-r1",
  "./assets/evorank-x1-r1.js?build=x6.1-r1",
  ...
  "./terms.html",
  "./support.html",
  "./icons/evorank-x4-180.png?build=x6.1-r1",
  "./icons/evorank-x4-192.png?build=x6.1-r1",
  "./icons/evorank-x4-512.png?build=x6.1-r1",
